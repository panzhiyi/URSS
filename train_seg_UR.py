...
class Trainer():
    ...
    def train(self, epoch):
        ...
        for i, batch in enumerate(tbar):
            ...
            tbar.set_description('Train [{0}] Loss {loss.val:.3f} {loss.avg:.3f} ELoss {eloss:.3f} Lr {lr:.5f} Best {best:.4f}'.format(epoch, loss=losses, eloss=loss_edge, lr=cur_lr, best=self.best_pred))
